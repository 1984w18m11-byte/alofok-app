...
const [selectedCalendarEvent,setSelectedCalendarEvent]=useState(null);
 ...
 <ScrollView contentContainerStyle={s.page}>
   <View style={s.topBar}>
    ...
    <Text style={s.topBarTitle}>{tab==='today'?'الأفق':tab==='calendar'?'التقويم':tab==='adhan'?'مواقيت الصلاة':tab==='adhkar'?'الأذكار':'الإعدادات'}</Text>
