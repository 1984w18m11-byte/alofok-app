...
const COPYRIGHT_SUMMARY=`© 2026 وسام محمد — جميع الحقوق محفوظة.

تعود إلى وسام محمد الحقوق الحصرية في الشفرة الأصلية، وبنية التطبيق، وتصميم الواجهات، والهوية البصرية، والنصوص والشروحات الأصلية، وتجميع البيانات، والرسومات والأصول التي أنشئت خصيصًا لتطبيق الأفق.

يُمنح المستخدم ترخيصًا شخصيًا محدودًا لاستخدام نسخة مشروعة من التطبيق فقط. لا يجوز دون إذن كتابي مسبق نسخ التطبيق أو نشره أو إعادة بيعه أو إنشاء نسخة مشتقة منه، أو استخراج شفرته أو موارده أو تقليد واجهته تقليدًا جوهريًا، أو إزالة اسم المالك وإشعارات الحقوق، أو استخدام اسم «الأفق» بما يوحي بوجود اعتماد رسمي.

عند رصد محتوى أو تطبيق ينسخ عناصر محمية، يحتفظ صاحب الحقوق بحقه في توثيق المخالفة، وإرسال مطالبة بالإزالة إلى المنصة أو المستضيف، وطلب وقف الاستخدام والتعويض واتخاذ الإجراءات القانونية المتاحة.
...
const EDUCATIONAL_LINKS=[
 {title:'محمد شحرور — مفهوم السنة والأشهر العربية',description:'ينقلك إلى نتائج YouTube المرتبطة بشرح محمد شحرور عن السنة والأشهر العربية.',url:'https://www.youtube.com/results?search_query=%D9%85%D8%AD%D9%85%D8%AF+%D8%B4%D8%AD%D8%B1%D9%88%D8%B1+%D8%A7%D9%84%D8%B3%D9%86%D8%A9+%D9%88%D8%A7%D9%84%D8%A3%D8%B4%D9%87%D8%B1+%D8%A7%D9%84%D8%B9%D8%B1%D8%A8%D9%8A%D8%A9'},
 {title:'محمد شحرور — النسيء وتثبيت مواسم الأشهر',description:'ينقلك إلى نتائج YouTube لحلقات النسيء وعلاقة أسماء الأشهر بالفصول.',url:'https://www.youtube.com/results?search_query=%D9%85%D8%AD%D9%85%D8%AF+%D8%B4%D8%AD%D8%B1%D9%88%D8%B1+%D8%A7%D9%84%D9%86%D8%B3%D9%8A%D8%A1+%D8%A7%D9%84%D8%A3%D8%B4%D9%87%D8%B1+%D8%A7%D9%84%D8%AD%D8%B1%D9%85'},
 {title:'محمد شحرور — رمضان والتقويم',description:'ينقلك إلى نتائج YouTube التي تجمع حلقاته المتعلقة برمضان والتقويم.',url:'https://www.youtube.com/results?search_query=%D9%85%D8%AD%D9%85%D8%AF+%D8%B4%D8%AD%D8%B1%D9%88%D8%B1+%D8%B1%D9%85%D8%B6%D8%A7%D9%86+%D8%A7%D9%84%D8%AA%D9%82%D9%88%D9%8A%D9%85'},
 {title:'عادل عصمت — التقويم الهجري وثبات الأشهر',description:'ينقلك إلى نتائج YouTube باسم الباحث والموضوع، لتختار المادة الأصلية المتاحة.',url:'https://www.youtube.com/results?search_query=%D8%B9%D8%A7%D8%AF%D9%84+%D8%B9%D8%B5%D9%85%D8%AA+%D8%A7%D9%84%D8%AA%D9%82%D9%88%D9%8A%D9%85+%D8%A7%D9%84%D9%87%D8%AC%D8%B1%D9%8A+%D8%AB%D8%A7%D8%A8%D8%AA'},
 {title:'باحثون عرب — التقويم الهجري الثابت',description:'ينقلك إلى نتائج YouTube لباحثين ومحاضرات تتناول ثبات الأشهر وعلاقتها بالفصول.',url:'https://www.youtube.com/results?search_query=%D8%A7%D9%84%D8%AA%D9%82%D9%88%D9%8A%D9%85+%D8%A7%D9%84%D9%87%D8%AC%D8%B1%D9%8A+%D8%A7%D9%84%D8%AB%D8%A7%D8%A8%D8%AA+%D8%A7%D9%84%D9%81%D8%B5%D9%88%D9%84'},
 {title:'شرح علمي للتقويم القمري–الشمسي',description:'ينقلك إلى نتائج تعليمية تشرح كيف تُوفَّق الشهور القمرية مع السنة الشمسية والفصول.',url:'https://www.youtube.com/results?search_query=%D8%B4%D8%B1%D8%AD+%D8%A7%D9%84%D8%AA%D9%82%D9%88%D9%8A%D9%85+%D8%A7%D9%84%D9%82%D9%85%D8%B1%D9%8A+%D8%A7%D9%84%D8%B4%D9%85%D8%B3%D9%8A'},
 {title:'مقالات الويب — ثبات التقويم الهجري',description:'ينقلك إلى بحث ويب أوسع عن المقالات والدراسات المؤيدة أو الناقدة للفكرة.',url:'https://www.google.com/search?q=%D8%A7%D9%84%D8%AA%D9%82%D9%88%D9%8A%D9%85+%D8%A7%D9%84%D9%87%D8%AC%D8%B1%D9%8A+%D8%A7%D9%84%D8%AB%D8%A7%D8%A8%D8%AA+%D8%A7%D9%84%D9%86%D8%B3%D9%8A%D8%A1+%D8%A7%D9%84%D9%81%D8%B5%D9%88%D9%84'}
];
...
const [selectedCalendarEvent,setSelectedCalendarEvent]=useState(null);
 ...
 async function openEducationalLink(url){
  try{await Linking.openURL(url)}catch(e){Alert.alert('تعذر فتح الرابط','تأكد من اتصال الإنترنت وحاول مرة أخرى.')}
 }
 ...
 <ScrollView contentContainerStyle={s.page}>
   <View style={s.topBar}>
    <Pressable accessibilityLabel='العودة إلى الرئيسية' style={s.topAction} onPress={()=>changeTab('today')}><Text style={s.topActionText}>⌂</Text></Pressable>
    <Text style={s.topBarTitle}>{tab==='today'?'الأفق':tab==='calendar'?'التقويم':tab==='adhan'?'مواقيت الصلاة':tab==='adhkar'?'الأذكار':tab==='education'?'فكرة التقويم':'الإعدادات'}</Text>
    <Pressable accessibilityLabel='فتح الإعدادات' style={s.topAction} onPress={()=>changeTab('settings')}><Text style={s.topActionText}>⚙</Text></Pressable>
   </View>
   {tab==='today'&&<View style={s.hero}>
    ...
    <Pressable style={s.locationPill} onPress={()=>useGps(true)}>
      ...
      <Text numberOfLines={1} style={s.locationText}>{locationBusy?'جاري تحديد الموقع...':locState}</Text>
    </Pressable>
   </View>}
   {tab==='today'&&<>
    <View style={s.quickActions}>
     <Pressable style={s.quickAction} onPress={()=>changeTab('calendar')}><Text style={s.quickIcon}>▦</Text><Text style={s.quickText}>التقويم</Text></Pressable>
     <Pressable style={s.quickAction} onPress={()=>changeTab('adhan')}><Text style={s.quickIcon}>◔</Text><Text style={s.quickText}>الصلاة</Text></Pressable>
     <Pressable style={s.quickAction} onPress={()=>changeTab('adhkar')}><Text style={s.quickIcon}>✦</Text><Text style={s.quickText}>الأذكار</Text></Pressable>
...
<Card title='مواقيت الصلاة'>
  ...
  <Pressable style={s.prayerLink} onPress={()=>changeTab('adhan')}>
   ...
   {tab==='education'&&<>
    <Card title='ما فكرة هذا التقويم؟'>
     <Text style={s.educationLead}>هذه الصفحة تشرح التصور البحثي الذي يستند إليه التقويم في تطبيق الأفق. الفكرة ليست التقويم الهجري القمري الرسمي المتداول، ولا تمثل فتوى أو اعتمادًا شرعيًا.</Text>
     <View style={s.verseBox}>
      <Text style={s.verseText}>﴿الشَّمْسُ وَالْقَمَرُ بِحُسْبَانٍ﴾</Text>
      <Text style={s.verseSource}>سورة الرحمن — الآية ٥</Text>
      <Text style={s.educationText}>المعنى عند جمهور المفسرين: أن الشمس والقمر يجريان بتقديرٍ وحساب دقيق ونظام لا يختل، وبهما تُعرف الأزمنة والمواقيت. والآية تدل على إمكان الحساب والانتفاع بحركتهما، لكنها لا تحدد وحدها نوعًا معينًا من التقويم؛ أما ربطها بتقويم قمري–شمسي ثابت فهو اجتهاد بحثي يحتاج إلى أدلة وشرح إضافيين.</Text>
     </View>
     <Text style={s.educationHeading}>السنة القمرية والسنة الشمسية</Text>
     <Text style={s.educationText}>الشهر القمري يبدأ بدورة القمر ويبلغ نحو 29 أو 30 يومًا. لذلك تكون اثنا عشر شهرًا قمريًا أقصر من السنة الشمسية بنحو أحد عشر يومًا، فتتنقل الشهور القمرية المتداولة بين الفصول.</Text>
     <Text style={s.educationHeading}>لماذا تُربط أسماء الأشهر بالفصول؟</Text>
     <Text style={s.educationText}>ينطلق هذا التصور من دلالة أسماء مثل ربيع الأول وربيع الآخر وجمادى، ويفترض أن للأشهر مواقع موسمية مقصودة: يبقى الربيع في الربيع، والخريف في الخريف، وتبقى بقية الأشهر، ومنها صفر ورمضان، ضمن ترتيب سنوي لا يطوف على جميع الفصول.</Text>
     <Text style={s.educationHeading}>كيف يمكن تثبيت المواسم؟</Text>
     <Text style={s.educationText}>يُستخدم نظام قمري–شمسي: تظل بدايات الشهور مرتبطة بحركة القمر والاقتران، ثم تُضاف فترة تصحيح عند الحاجة لمعادلة الفرق المتراكم مع السنة الشمسية. يشبه المبدأ العام آلية الكبس في التقاويم القمرية–الشمسية، مع اختلاف القواعد والتسمية.</Text>
     <Text style={s.educationHeading}>ما الذي يفعله تطبيق الأفق؟</Text>
     <Text style={s.educationText}>يعرض نموذجًا حسابيًا تقديريًا لهذه الفكرة إلى جانب التقويم الميلادي، ويستخدم موقع الجهاز والحسابات الفلكية. النتائج للبحث والمقارنة، وقد تختلف عن التقويم الهجري الرسمي ورؤية الهلال والجهات الدينية في بلدك.</Text>
    </Card>
    <Card title='حلقات وشروحات مرتبة'>
     <Text style={s.researchNotice}>الروابط التالية تفتح YouTube أو بحث الويب خارج التطبيق. وُصفت كرابط نتائج بحث حتى تبقى المواد المتاحة والمصادر الأصلية ظاهرة بوضوح، ولا ننسب عنوان حلقة غير موثّق.</Text>
     {EDUCATIONAL_LINKS.map((item,index)=><Pressable key={item.url} style={s.educationLink} onPress={()=>openEducationalLink(item.url)}>
      <Text style={s.educationLinkNumber}>{index+1}</Text>
      <View style={s.educationLinkBody}><Text style={s.educationLinkTitle}>{item.title}</Text><Text style={s.educationLinkDescription}>{item.description}</Text><Text style={s.educationLinkAction}>{item.url.includes('youtube')?'فتح في YouTube ←':'فتح بحث الويب ←'}</Text></View>
     </Pressable>)}
    </Card>
   </>}
   {tab==='calendar'&&<>
   ...
   {tab==='adhkar'&&<>
    <Card title='أذكار اليوم'>
     <View style={s.dhikrItem}><Text style={s.dhikrTitle}>آية الكرسي</Text><Text style={s.sub}>مرة واحدة صباحًا ومساءً</Text></View>
     <View style={s.dhikrItem}><Text style={s.dhikrTitle}>سُبْحَانَ اللهِ وَبِحَمْدِهِ</Text><Text style={s.sub}>١٠٠ مرة</Text></View>
     <View style={s.dhikrItem}><Text style={s.dhikrTitle}>أَسْتَغْفِرُ اللهَ وَأَتُوبُ إِلَيْهِ</Text><Text style={s.sub}>١٠٠ مرة</Text></View>
     <View style={s.dhikrItem}><Text style={s.dhikrTitle}>اللهم صلِّ على محمد وآل محمد</Text><Text style={s.sub}>ذكر مفتوح</Text></View>
    </Card>
   </>}
{tab==='settings'&&<>
    ...
    <Card title='حقوق الطبع والملكية الفكرية'>
     ...
     <Pressable style={s.secondaryButton} onPress={()=>setShowCopyright(v=>!v)}><Text style={s.secondaryButtonText}>{showCopyright?'إخفاء الحقوق':'قراءة الحقوق وشروط الاستخدام'}</Text></Pressable>
     {showCopyright&&<><Text style={s.policyText}>{COPYRIGHT_SUMMARY}</Text><Text style={s.policyMeta}>جميع الحقوق محفوظة • لا يُمنح أي ترخيص ضمني • المكونات الخارجية مستثناة وتبقى خاضعة لتراخيصها.</Text></>}
    </Card>
   </>}
  </ScrollView>
  </SafeAreaView>
...
const s=StyleSheet.create({
 background:{flex:1,backgroundColor:'#041620'},backgroundShade:{...StyleSheet.absoluteFillObject,opacity:.64},root:{flex:1,backgroundColor:'transparent'},themeSky:{position:'absolute',top:0,left:0,right:0,height:300,opacity:.38,overflow:'hidden'},themeSymbol:{position:'absolute',top:42,right:34,fontSize:82,fontWeight:'900'},themeOrb:{position:'absolute',width:240,height:240,borderRadius:120,borderWidth:2,top:115,left:-90,opacity:.28},themeLabel:{fontSize:12,fontWeight:'800',textAlign:'center',marginBottom:10},page:{paddingHorizontal:14,paddingTop:8,paddingBottom:104},top:{gap:6},badge:{color:'#f4bb52',fontWeight:'800',textAlign:'right'},hero:{alignItems:'center',paddingTop:16,paddingBottom:12},appName:{color:'#f4bb52',fontSize:42,fontWeight:'900',textAlign:'center',marginTop:0},appSub:{color:'#d5dde2',fontSize:15,fontWeight:'700',textAlign:'center',marginTop:4,marginBottom:10},locationPill:{alignSelf:'flex-end',maxWidth:'58%',minHeight:38,paddingVertical:7,paddingHorizontal:12,borderRadius:19,borderWidth:1,borderColor:'#c89232',backgroundColor:'rgba(5,20,30,.78)',flexDirection:'row',alignItems:'center',justifyContent:'center',gap:5},locationPin:{fontSize:14},locationText:{color:'#eef4f7',fontSize:12,fontWeight:'700',textAlign:'center',flexShrink:1},loc:{color:'#b5c7d1',textAlign:'right',fontSize:12,flexShrink:1,maxWidth:'72%'},clockCard:{alignItems:'center',paddingVertical:18,paddingHorizontal:14,marginTop:8,borderRadius:22,borderWidth:1,borderColor:'#8f6827',backgroundColor:'rgba(3,15,24,.78)'},clock:{color:'#f4bb52',fontSize:28,fontWeight:'900',marginTop:8},week:{color:'#ffffff',fontSize:20,fontWeight:'900',marginBottom:8},hdate:{textAlign:'center',fontSize:27,fontWeight:'900',color:'#fff'},gdate:{textAlign:'center',fontSize:20,fontWeight:'800',color:'#fff'},textCenter:{color:'#eef4f7',textAlign:'center',marginTop:8},prayerHint:{color:'#9fb7c5',fontSize:13,fontWeight:'700',textAlign:'right',marginBottom:10},ramadanMini:{marginTop:14,width:'100%',backgroundColor:'rgba(185,135,47,.9)',borderRadius:16,paddingVertical:12,paddingHorizontal:14,alignItems:'center'},ramadanMiniTitle:{color:'#fff',fontSize:18,fontWeight:'900'},ramadanMiniText:{color:'#fff',fontSize:13,fontWeight:'700',marginTop:4,textAlign:'center'},
 ...
 card:{backgroundColor:'rgba(3,18,28,.79)',borderRadius:24,padding:17,marginTop:14,borderWidth:1,borderColor:'rgba(207,157,68,.68)',shadowColor:'#000',shadowOpacity:0.34,shadowRadius:12,shadowOffset:{width:0,height:5},elevation:5},title:{color:'#f4bb52',fontSize:21,fontWeight:'900',textAlign:'right',marginBottom:14},text:{color:'#eef4f7',textAlign:'right',lineHeight:24},row:{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingVertical:11,borderBottomWidth:1,borderBottomColor:'#1e4055'},settingRow:{minHeight:78,flexDirection:'row-reverse',alignItems:'center',gap:12,padding:12,marginBottom:8,borderRadius:18,backgroundColor:'rgba(2,15,24,.72)',borderWidth:1,borderColor:'rgba(80,103,118,.35)'},settingIcon:{fontSize:22},settingText:{flex:1},soundSelector:{minHeight:84,flexDirection:'row-reverse',alignItems:'center',gap:12,padding:12,borderRadius:18,backgroundColor:'rgba(2,15,24,.72)',borderWidth:1,borderColor:'rgba(80,103,118,.35)'},chevron:{color:'#f4bb52',fontSize:36},volumeBox:{padding:15,marginTop:10,borderRadius:18,backgroundColor:'rgba(2,15,24,.72)'},volumeTrack:{flexDirection:'row',gap:6,marginTop:16},volumeStep:{flex:1,height:8,borderRadius:4,backgroundColor:'#45525b'},volumeStepOn:{backgroundColor:'#f4bb52'},selectedSound:{backgroundColor:'rgba(200,146,50,.18)'},adhanChoice:{flexDirection:'row-reverse',justifyContent:'space-between',alignItems:'center',paddingVertical:13,borderBottomWidth:1,borderBottomColor:'#1e4055'},playIcon:{color:'#f4bb52',fontSize:18},stopButton:{backgroundColor:'#5b2525',borderWidth:1,borderColor:'#e16b6b',padding:13,borderRadius:12,marginTop:10},stopButtonDisabled:{opacity:.4},stopButtonText:{color:'#fff',fontWeight:'900',textAlign:'center'},warn:{color:'#ffcb6b'},ok:{color:'#87d8a4'},
