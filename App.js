...
const [selectedCalendarEvent,setSelectedCalendarEvent]=useState(null);
 ...
 const weeklyAdActive=APP_VARIANT==='trial'&&weeklyAd.enabled===true&&Boolean(weeklyAd.title)&&(!adStart||now>=adStart)&&(!adEnd||now<=adEnd)&&dismissedAdWeek!==currentAdWeek;
