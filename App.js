...
const PRIVACY_SUMMARY='يستخدم الأفق الموقع الدقيق أثناء تشغيل التطبيق لحساب المواقيت وعرض اسم المنطقة. تُحفظ الإحداثيات والتفضيلات محليًا على جهازك ولا يرسل التطبيق موقعك إلى المطور. يتصل التطبيق بصفحة مشروع الأفق على GitHub لفحص رقم أحدث إصدار فقط، دون إرسال إحداثياتك. لا توجد حسابات مستخدمين أو شبكة إعلانات خارجية في النسخة الحالية، ولا نبيع بيانات شخصية. يمكنك سحب الأذونات أو حذف البيانات من إعدادات جهازك.';
