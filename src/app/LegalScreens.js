...
export function PrivacyScreen({rtl,onBack,onNavigate}){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.content}>
  ...
  <Card title={ar?'طبيعة التطبيق':'About the app'} rtl={rtl}><Paragraph rtl={rtl}>{ar?'الأفق / Al-Ufuq مشروع تقويمي وتقني وبحثي، وليس جهة دينية رسمية. صاحب المشروع وحقوقه الأصلية: وسام محمد — Wissam Digital. تعرض النسختان التجريبية وPlus التقويمات والمواقيت والمناسبات والخدمات المرتبطة بها بحسب الميزات المتاحة في كل نسخة.':'Al-Ufuq is a calendar, technology and research project, not an official religious authority. Project owner and original-rights notice: Wissam Mohammed — Wissam Digital. Trial and Plus provide calendars, prayer times, events and related services according to the features available in each edition.'}</Paragraph></Card>
...
export function CopyrightScreen({rtl,onBack}){
 ...
 return <SafeAreaView style={s.safe}><ScrollView contentContainerStyle={s.content}>
  ...
  <Card title={ar?'حقوق الأفق':'Al-Ufuq rights'} rtl={rtl}><Paragraph rtl={rtl}>{ar?'© 2026 وسام محمد — Wissam Digital — Al-Ufuq / الأفق. جميع حقوق الطبع والنشر والملكية الفكرية محفوظة في الشفرة البرمجية الأصلية، تصميم الواجهات، الشعارات والأيقونات الأصلية، ترتيب المحتوى، النصوص والمواد التي أُنشئت خصيصًا للمشروع، وذلك إلى الحد الذي يسمح به القانون.':'© 2026 Wissam Mohammed — Wissam Digital — Al-Ufuq. Copyright and intellectual-property rights are reserved in the original source code, interface design, original logos and icons, content arrangement, text and materials created specifically for the project, to the extent permitted by law.'}</Paragraph></Card>
...
export function AuthenticityScreen({rtl,onBack,edition,version}){
 ...
 const localQrValue=challenge?.installationId?`Al-Ufuq|owner=Wissam Mohammed - Wissam Digital|edition=${edition}|version=${version}|installation=${challenge.installationId}|type=official-copy-identity`:'';
