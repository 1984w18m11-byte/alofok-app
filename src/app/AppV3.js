...
function AboutScreen({t,rtl,onBack}){
 return <SafeAreaView style={s.flatSafe}><ScrollView contentContainerStyle={s.screenContent}>
  ...
  <SectionCard title={rtl?'حقوق الطبع والنشر والملكية الفكرية':'Copyright & intellectual property'} rtl={rtl}><Text style={[s.bodyText,textDir(rtl)]}>{rtl?'© 2026 وسام محمد – جميع حقوق الطبع والنشر محفوظة. حقوق الملكية الفكرية الخاصة بالشفرة الأصلية، الواجهات، الشعارات، الأيقونات، النصوص والمواد المنشأة خصيصًا لتطبيق الأفق محفوظة لصاحب المشروع، مع بقاء المواد المرخصة من جهات أخرى خاضعة لحقوق أصحابها وتراخيصها.':'© 2026 Wissam Mohammed — Wissam Digital. Copyright and intellectual-property rights in the original source code, interfaces, original logos, icons, text and project-specific materials of al ufuq are reserved to project owner Wissam Mohammed. Third-party licensed materials remain subject to their owners and license terms.'}</Text></SectionCard>
  <Text style={s.versionText}>© 2026 وسام محمد – جميع حقوق الطبع والنشر محفوظة · v{VERSION}</Text>
 </ScrollView></SafeAreaView>
}
