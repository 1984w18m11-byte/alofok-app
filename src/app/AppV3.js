...
const s=StyleSheet.create({
 ...
 adhanCard:{backgroundColor:CARD_2,borderWidth:1,borderColor:LINE,borderRadius:17,padding:11,marginTop:10},selectedGold:{borderColor:GOLD,borderWidth:1.5,shadowColor:GOLD,shadowOpacity:.35,shadowRadius:7,elevation:3},adhanRow:{alignItems:'center',gap:12},adhanTextWrap:{flex:1},adhanName:{color:WHITE,fontSize:16,fontWeight:'800'},adhanMeta:{color:MUTED,fontSize:11,marginTop:5,lineHeight:16},radio:{width:26,height:26,borderRadius:13,borderWidth:2,borderColor:'#8B95A0',alignItems:'center',justifyContent:'center'},radioSelected:{backgroundColor:GOLD,borderColor:GOLD},radioCheck:{color:NAVY,fontWeight:'900'},volumeBox:{marginTop:12,padding:14,borderRadius:18,backgroundColor:CARD_2,borderWidth:1,borderColor:LINE},volumeHeader:{alignItems:'center',justifyContent:'space-between',marginBottom:12},volumeTitle:{color:WHITE,fontSize:14,fontWeight:'800',flex:1},volumePercent:{color:GOLD,fontSize:14,fontWeight:'900'},volumeControls:{flexDirection:'row',alignItems:'center',gap:9},volumeButton:{width:40,height:40,borderRadius:13,borderWidth:1,borderColor:GOLD_SOFT,alignItems:'center',justifyContent:'center',backgroundColor:'rgba(244,196,93,.09)'},volumeButtonText:{color:GOLD,fontSize:24,fontWeight:'800'},volumeSegments:{flex:1,height:34,flexDirection:'row',alignItems:'center',gap:4},volumeSegment:{flex:1,height:10,borderRadius:5,backgroundColor:'rgba(255,255,255,.16)'},volumeSegmentActive:{backgroundColor:GOLD},errorText:{color:'#FFB4B4',marginTop:10,fontSize:12},
